...
export function CinematicHero({
  ...
  cardDescription = (
    <>
      <span className="text-white font-semibold">Nexorith Studio</span> crafts
      AI-driven ecosystems and hyper-scale web applications with bold, massive,
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative w-screen h-screen overflow-hidden flex items-center justify-center bg-[#030306] text-foreground font-sans antialiased",
        className
      )}
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 z-0">
        <div className="absolute -left-1/4 top-[-20%] h-[72%] w-[72%] pointer-events-none">
          <div className="animate-aurora h-full w-full rounded-full bg-cyan-500/22 blur-[130px]" />
        </div>
        <div className="absolute bottom-[-32%] right-[-22%] h-[62%] w-[58%] pointer-events-none">
