    ...
    <div className="container mx-auto px-3 md:px-10">
      <div className="px-5 py-32">
        ...
        <p className="max-w-md font-circular-web text-lg text-[#dfdff2] opacity-50">
          ...
          technologies converge into transformative digital experiences for your business.
        </p>
      </div>
      ...
      <div className="grid h-[135vh] w-full grid-cols-2 grid-rows-3 gap-7">
        <BentoTilt className="bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2">
          <BentoCard
            ...
            description="AI-driven solutions and intelligent automation to supercharge your digital products."
            isComingSoon
          />
        </BentoTilt>
        ...
        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard
            ...
            description="Scalable cloud infrastructure and deployment strategies for hyper-scale applications."
            isComingSoon
          />
        </BentoTilt>
